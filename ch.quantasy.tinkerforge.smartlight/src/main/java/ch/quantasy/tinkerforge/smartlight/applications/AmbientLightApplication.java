...
/**
 * This class represents a TinkerforgeApplication which is responsible for telling the difference of 'dark' and 'bright'
 * ambient. <br/>
 * It will manage the first {@link BrickletAmbientLight} that will be presented to this {@link TinkerforgeApplication}.
 * <br/>
 * It is written in a 'part-of' style, meaning that it serves as a slave for the {@link LightApplication}. It would be
 * better to write it as a component which allows to add a listener...
 *
 * @author reto
 *
 */
public class AmbientLightApplication extends AbstractTinkerforgeApplication
    ...
    /**
     * Sets the maximum amount of Lux which is still 'dark'. In order to work properly, this value must be slightly
     * higher (some Lux) than the according minimum. This creates a histerese which avoids 'flickering'.
     *
    ...
    /**
     * Sets the minimum amount of Lux which will initiate the change to 'dark'. In order to work properly, this value
     * must be slightly lower (some Lux) than the according maximum. This creates a histerese which avoids 'flickering'.
     *
     * @param ambientHistereseMaxInLux
     */
