...
/**
 * This class manages the {@link TinkerforgeStackAgent}s that should be
 * taken into consideration by the {@link TinkerforgeApplication}.
 * 
 * @author reto
 *
 */
public class ApplicationManagement {
	public static void main(final String[] args) throws IOException {
		...
		System.out.println("... the application and agent are related to each other");
		application.addTinkerforgeStackAgent(identifier);
		
		System.out.println("Press key to exit");
		System.in.read();
		System.out.println("The relation between application and agent will be broken.");
