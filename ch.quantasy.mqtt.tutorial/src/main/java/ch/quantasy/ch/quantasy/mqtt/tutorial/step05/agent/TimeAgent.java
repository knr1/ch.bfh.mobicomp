...
public class TimeAgent {
	...
	CONNECTION_ID = "ch.quantasy.mqtt.tutorial.TimeAgent.step05";
	...
	mqttClient.subscribe(TIME_SERVICE_TIME_10_TOPIC);
	mqttClient.subscribe(TIME_SERVICE_TIME_5_TOPIC);
	...
	mqttClient.unsubscribe(TIME_SERVICE_TIME_10_TOPIC);
	mqttClient.unsubscribe(TIME_SERVICE_TIME_5_TOPIC);
    }
