package ch.quantasy.ch.quantasy.mqtt.tutorial.step04.agent;

import ch.quantasy.ch.quantasy.mqtt.tutorial.step04.service.TimeService;
import java.net.URI;
...
public class TimeAgent {
	...
	CONNECTION_ID = "ch.quantasy.mqtt.tutorial.TimeAgent.step04";
	...
	System.out.println("A horrilbe thing happened and the network connection is lost.");
	System.exit(0);
