 ...
 */
public class HumidityValueEvent extends AnEvent {

    public HumidityValueEvent(AHandler deviceHandler, String eventTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, eventTopic, "humidityValue", mqttClient);
