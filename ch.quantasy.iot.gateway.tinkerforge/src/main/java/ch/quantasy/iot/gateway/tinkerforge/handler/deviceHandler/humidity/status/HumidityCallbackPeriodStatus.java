...
public class HumidityCallbackPeriodStatus extends AStatus {
    ...
    public HumidityCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "humidityCallbackPeriod", mqttClient);
