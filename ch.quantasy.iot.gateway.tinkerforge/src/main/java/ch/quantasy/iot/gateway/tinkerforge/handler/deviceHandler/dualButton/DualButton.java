 ...
 */
package ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.dualButton;

import ch.quantasy.iot.gateway.tinkerforge.base.message.AnIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.base.ADeviceHandler;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.dualButton.event.StateChangedEvent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.dualButton.intent.DualLEDIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.dualButton.intent.LEDIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.dualButton.status.DualLEDStatus;
