...
public abstract class AnEvent {
	...
	descriptions.add(new EventDescription("/" + ADeviceHandler.DEVICE_DESCRIPTION_TOPIC + "/" + deviceHandler.getApplicationName() + "/[identificationString]/event", "/" + eventName, "/" + eventPropertyName, type, representation, range));
    }
