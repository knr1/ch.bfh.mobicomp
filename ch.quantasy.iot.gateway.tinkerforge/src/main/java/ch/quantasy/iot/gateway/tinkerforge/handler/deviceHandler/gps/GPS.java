package ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps;
...
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.event.DateTimeEvent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.event.MotionEvent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.AltitudeCallbackPeriodIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.CoordinatesCallbackPeriodIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.DateTimeCallbackPeriodIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.MotionCallbackPeriodIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.RestartIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.intent.StatusCallbackPeriodIntent;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.AltitudeCallbackPeriodStatus;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.CoordinatesCallbackPeriodStatus;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.DateTimeCallbackPeriodStatus;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.GPSStatus;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.MotionCallbackPeriodStatus;
import ch.quantasy.iot.gateway.tinkerforge.handler.deviceHandler.gps.status.StatusCallbackPeriodStatus;
