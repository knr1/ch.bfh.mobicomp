...
public class MotionCallbackPeriodStatus extends AStatus {
    ...
    public MotionCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "motionCallbackPeriod", mqttClient);
