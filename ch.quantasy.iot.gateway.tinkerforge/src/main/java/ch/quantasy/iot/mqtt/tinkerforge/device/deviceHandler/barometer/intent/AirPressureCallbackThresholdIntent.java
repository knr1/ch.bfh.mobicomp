 ...
 */
public class AirPressureCallbackThresholdIntent extends AnIntent<Barometer> {

    public AirPressureCallbackThresholdIntent(Barometer deviceHandler, String intentTopic) {
