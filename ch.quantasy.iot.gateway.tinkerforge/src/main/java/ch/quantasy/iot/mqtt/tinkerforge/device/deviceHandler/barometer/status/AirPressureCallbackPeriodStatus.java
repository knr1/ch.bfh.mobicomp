 ...
 */
public class AirPressureCallbackPeriodStatus extends AStatus {

    public AirPressureCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
