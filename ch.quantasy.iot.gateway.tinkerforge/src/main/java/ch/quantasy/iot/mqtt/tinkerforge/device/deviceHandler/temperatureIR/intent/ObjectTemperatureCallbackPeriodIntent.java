 ...
 */
public class ObjectTemperatureCallbackPeriodIntent extends AnIntent {

    public ObjectTemperatureCallbackPeriodIntent(AHandler deviceHandler, String intentTopic) {
