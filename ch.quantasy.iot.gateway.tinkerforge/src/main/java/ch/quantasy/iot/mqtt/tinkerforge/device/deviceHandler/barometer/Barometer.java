...
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.event.AltitudeReachedEvent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.AirPressureCallbackPeriodIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.AirPressureCallbackThresholdIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.AltitudeCallbackPeriodIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.AltitudeCallbackThresholdIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.AveragingIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.intent.DebouncePeriodIntent;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.status.AirPressureCallbackPeriodStatus;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.status.AirPressureCallbackThresholdStatus;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.status.AltitudeCallbackPeriodStatus;
import ch.quantasy.iot.mqtt.tinkerforge.device.deviceHandler.barometer.status.AltitudeCallbackThresholdStatus;
