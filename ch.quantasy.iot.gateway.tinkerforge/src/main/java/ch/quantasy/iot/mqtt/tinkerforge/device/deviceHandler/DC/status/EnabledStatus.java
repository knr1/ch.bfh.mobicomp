 ...
 */
public class EnabledStatus extends AStatus {

    public EnabledStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "enabled", mqttClient);
