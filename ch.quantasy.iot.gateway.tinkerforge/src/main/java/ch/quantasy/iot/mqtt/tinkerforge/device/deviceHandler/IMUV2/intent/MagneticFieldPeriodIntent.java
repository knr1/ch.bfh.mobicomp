 ...
 */
public class MagneticFieldPeriodIntent extends AnIntent<IMUV2> {

    public MagneticFieldPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "magneticField");
