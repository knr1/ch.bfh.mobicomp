 ...
 */
public class AccelerationPeriodStatus extends AStatus {

    public AccelerationPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
