...
public class StatusCallbackPeriodStatus extends AStatus {
    ...
    public StatusCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "statusCallbackPeriod", mqttClient);
