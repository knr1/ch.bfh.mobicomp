 ...
 */
public class QuaternionPeriodStatus extends AStatus {

    public QuaternionPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "quaternion", mqttClient);
