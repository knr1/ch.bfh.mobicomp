 ...
 */
public class GravityPeriodIntent extends AnIntent<IMUV2> {

    public GravityPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "gravity");
