 ...
 */
public class GravityPeriodStatus extends AStatus {

    public GravityPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "gravitiy", mqttClient);
