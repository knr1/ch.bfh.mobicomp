 ...
 */
public class GravityVectorEvent extends AnEvent {

    public GravityVectorEvent(AHandler deviceHandler, String eventTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, eventTopic, "gravityVector", mqttClient);
