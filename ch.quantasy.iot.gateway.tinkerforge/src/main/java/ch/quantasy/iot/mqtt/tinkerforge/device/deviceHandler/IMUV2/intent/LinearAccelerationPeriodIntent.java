 ...
 */
public class LinearAccelerationPeriodIntent extends AnIntent<IMUV2> {

    public LinearAccelerationPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "linearAcceleration");
