 ...
 */
public class DustDensityReachedEvent extends AnEvent {

    public DustDensityReachedEvent(AHandler deviceHandler, String eventTopic, MqttAsyncClient mqttClient) {
