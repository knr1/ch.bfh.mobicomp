 ...
 */
public class OrientationPeriodIntent extends AnIntent<IMUV2> {

    public OrientationPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "orientation");
