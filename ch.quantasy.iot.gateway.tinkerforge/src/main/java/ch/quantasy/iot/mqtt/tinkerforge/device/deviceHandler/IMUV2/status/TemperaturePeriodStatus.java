 ...
 */
public class TemperaturePeriodStatus extends AStatus {

    public TemperaturePeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "temperature", mqttClient);
