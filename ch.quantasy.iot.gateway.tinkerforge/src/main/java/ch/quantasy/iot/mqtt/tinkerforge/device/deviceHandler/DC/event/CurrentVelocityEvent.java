 ...
 */
public class CurrentVelocityEvent extends AnEvent {

    public CurrentVelocityEvent(AHandler deviceHandler, String eventTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, eventTopic, "currentVelocity", mqttClient);
