 ...
 */
public class AngularVelocityEvent extends AnEvent {

    public AngularVelocityEvent(AHandler deviceHandler, String eventTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, eventTopic, "angularVelocity", mqttClient);
