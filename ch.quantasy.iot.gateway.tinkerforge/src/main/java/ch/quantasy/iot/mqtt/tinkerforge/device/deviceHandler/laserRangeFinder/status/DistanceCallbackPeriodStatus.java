...
public class DistanceCallbackPeriodStatus extends AStatus {
    ...
    public DistanceCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "distanceCallbackPeriod", mqttClient);
