 ...
 */
public class AngularVelocityPeriodIntent extends AnIntent<IMUV2> {

    public AngularVelocityPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "angularVelocity");
