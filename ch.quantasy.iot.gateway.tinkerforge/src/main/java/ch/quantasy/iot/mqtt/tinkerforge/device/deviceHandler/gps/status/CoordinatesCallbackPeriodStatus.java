...
public class CoordinatesCallbackPeriodStatus extends AStatus {
    ...
    public CoordinatesCallbackPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "coordinatesCallbackPeriod", mqttClient);
