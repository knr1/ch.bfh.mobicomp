 ...
 */
public class QuaternionPeriodIntent extends AnIntent<IMUV2> {

    public QuaternionPeriodIntent(IMUV2 deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "quaternion");
