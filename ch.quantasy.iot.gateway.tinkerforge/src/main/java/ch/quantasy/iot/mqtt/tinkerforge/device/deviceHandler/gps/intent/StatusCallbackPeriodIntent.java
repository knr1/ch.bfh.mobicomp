 ...
 */
public class StatusCallbackPeriodIntent extends AnIntent {

    public StatusCallbackPeriodIntent(AHandler deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "statusCallbackPeriod");
