 ...
 */
public class OrientationPeriodStatus extends AStatus {

    public OrientationPeriodStatus(AHandler deviceHandler, String statusTopic, MqttAsyncClient mqttClient) {
	super(deviceHandler, statusTopic, "orientation", mqttClient);
