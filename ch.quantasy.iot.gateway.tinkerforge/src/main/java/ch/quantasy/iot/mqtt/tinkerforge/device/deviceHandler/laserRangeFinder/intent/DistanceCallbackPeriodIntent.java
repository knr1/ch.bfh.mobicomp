 ...
 */
public class DistanceCallbackPeriodIntent extends AnIntent<LaserRangeFinder> {

    public DistanceCallbackPeriodIntent(LaserRangeFinder deviceHandler, String intentTopic) {
	super(deviceHandler, intentTopic, "distanceCallbackPeriod");
