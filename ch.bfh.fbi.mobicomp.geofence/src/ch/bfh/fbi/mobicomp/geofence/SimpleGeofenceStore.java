...
public class SimpleGeofenceStore {
    ...
    private final SharedPreferences geofencePreferences;
    ...
    public SimpleGeofence getGeofence(String id) {
         ...
         * if it doesn't exist
         */
        double latitude = geofencePreferences.getFloat(
         ...
         */
        double longitude = geofencePreferences.getFloat(
         ...
         * if it doesn't exist
         */
        float radius = geofencePreferences.getFloat(
         ...
         */
        long expirationDuration = geofencePreferences.getLong(
         ...
         * id, or GeofenceUtils.INVALID_VALUE if it doesn't exist
         */
        int transitionType = geofencePreferences.getInt(
                getGeofenceFieldKey(id, GeofenceUtils.KEY_TRANSITION_TYPE),
                GeofenceUtils.INVALID_INT_VALUE);

        // If none of the values is incorrect, return the object
        if (
            latitude != GeofenceUtils.INVALID_FLOAT_VALUE &&
            longitude != GeofenceUtils.INVALID_FLOAT_VALUE &&
    ...
    public void setGeofence(String id, SimpleGeofence geofence) {
         ...
         * and non-concurrent
         */
        Editor editor = geofencePreferences.edit();
