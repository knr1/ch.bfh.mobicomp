 ...
 */
package ch.quantasy.iot.bridge.mqtt.tinkerforge.examples.rotaryPoti;
...
public class RotaryPoti {
    ...
    public static final String UID = "RotaryPoti-Example";

    private MqttAsyncClient client;

    public RotaryPoti() throws MqttException, InterruptedException {
	...
	RotaryPoti button = new RotaryPoti();
	button.connect();
