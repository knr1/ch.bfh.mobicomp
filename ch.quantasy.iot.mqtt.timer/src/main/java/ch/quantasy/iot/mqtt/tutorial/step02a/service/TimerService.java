 ...
 * The 'business logic' is invoked once via the service
 */
package ch.quantasy.iot.mqtt.tutorial.step02a.service;

import ch.quantasy.iot.mqtt.tutorial.step02a.communication.MQTTCommunication;
import ch.quantasy.iot.mqtt.tutorial.step02a.communication.MQTTParameters;
import static ch.quantasy.iot.mqtt.tutorial.step02a.service.TimerService.EVENT_TOPIC_TIME;
import ch.quantasy.iot.mqtt.tutorial.step02a.timer.TickTimer;
import ch.quantasy.iot.mqtt.tutorial.step02a.timer.TickTimerParameters;
import java.net.URI;
 ...
 * @author reto
 */
public class TimerService implements MqttCallback {
    ...
    public TimerService() throws MqttException {
        ...
        LocalDateTime result = tickTimer.tick(tickTimerParameters);
        if (result != null) {
