package ch.bfh.fbi.mobicomp.tinkerforge.tutorial.step07.step06;

import ch.bfh.fbi.mobicomp.tinkerforge.tutorial.step06.MotionDetectorApplication;
...
/**
 * A {@link TinkerforgeApplication} can consist of multiple {@link TinkerforgeApplication}s. Here, the two specialized
 * applications are managed by this one. The only thing this {@link TinkerforgeApplication} does is, to lower the
 * energy-consumption of {@link BrickMaster}s with WiFi extension... if any is provided.
 *
 * @author reto
 *
 */
