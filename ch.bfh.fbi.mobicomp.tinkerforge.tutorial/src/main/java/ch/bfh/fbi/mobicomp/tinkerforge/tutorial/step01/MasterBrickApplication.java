...
/**
 * This does exactly the same as the example in {@link ExampleStackStatus}. However, this implementation is programmed
 * to work in the 'rough' world: It just works even under heavy circumstances! You do not have to know the UIDs and such
 * to make it run. Just have fun programming the logic. <br/>
 *
 * By extending the {@link AbstractTinkerforgeApplication} almost everything is set and ready. The only methods to be
 * implemented are:
 * <ul>
 ...
 * <li>hashCode</li>
 * </ul>
 * But why that? Because internally all {@link TinkerforgeApplication} are held within a {@link Set}. And that is why it
 * is so important to know when YOU think two {@link TinkerforgeApplication}s should be alike (=equals)
 *
 * @author reto
 *
 */
