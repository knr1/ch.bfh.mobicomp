package ch.quantasy.ch.quantasy.tinkerforge.fridgeit.sensor;

import ch.quantasy.ch.quantasy.tinkerforge.fridgeit.FridgeIt;
...
public class AmbientLightApplication extends AbstractTinkerforgeApplication
    ...
    /**
     * Sets the minimum amount of Lux which is STILL 'bright'. In order to work properly, this value must be slightly
     * lower (some Lux) than the according maximum. This creates a histerese which avoids 'flickering'.
     *
     * @param ambientHistereseMaxInLux
     */
