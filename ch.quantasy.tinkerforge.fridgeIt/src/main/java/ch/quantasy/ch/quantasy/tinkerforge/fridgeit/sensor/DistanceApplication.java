...
/**
 * This class represents a TinkerforgeApplication which is responsible for telling the difference of 'near' and 'far'
 * away.
 *
 *
...
public class DistanceApplication extends AbstractTinkerforgeApplication
    ...
    /**
     * Sets the maximum distance in mm which is STILL 'near'. In order to work properly, this value must be slightly
     * higher (some mm) than the according minimum. This creates a histerese which avoids 'flickering'.
     *
    ...
    /**
     * Sets the minimum amount of mm which is STILL 'far'. In order to work properly, this value must be slightly lower
     * (some mm) than the according maximum. This creates a histerese which avoids 'flickering'.
     *
