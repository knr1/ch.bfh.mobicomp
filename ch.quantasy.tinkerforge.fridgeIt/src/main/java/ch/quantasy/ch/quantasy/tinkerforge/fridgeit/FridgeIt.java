...
import ch.quantasy.ch.quantasy.tinkerforge.fridgeit.sensor.AmbientLightApplication;
import ch.quantasy.ch.quantasy.tinkerforge.fridgeit.sensor.DistanceApplication;
import ch.quantasy.ch.quantasy.tinkerforge.fridgeit.sensor.HumidityApplication;
import ch.quantasy.ch.quantasy.tinkerforge.fridgeit.sensor.TemperatureApplication;
...
/**
 * This class is used to fuse the {@link FridgeSensor} and the {@link FridgeViewer}. * It assumes that the viewer-stack
 * is can be accessed by the server-name <i>'localhost'</i> . <br/>
...
public class FridgeIt extends AbstractTinkerforgeApplication {
    ...
    /**
     * The {@link FridgeSensor} and the {@link FridgeViewer} are instantiated and connected. The instance will only
     * exist if everything went fine.
     *
    ...
    /**
     * Information if the interieur light of the fridge is lit or not. The info is passed to the {@link FridgeViewer}
     *
     * The histerese-threshold must be set in the {@link AmbientLightApplication}.
     */
    ...
    /**
     * This class is responsible for receiving, processing and delegating data about the door-state.
     *
     * @author reto
     *
     */
