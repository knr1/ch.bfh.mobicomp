...
public class FridgeItSimulation {
	...
	public static final TinkerforgeStackAgentIdentifier FRIDGE_VIEWER = new TinkerforgeStackAgentIdentifier(
			"localhost");
	...
	public static void main(final String[] args) throws UnknownHostException,
		...
		try {
			...
			fridgeViewer.addTinkerforgeStackAgent(FRIDGE_VIEWER);
			...
			fridgeViewer.removeTinkerforgeStackAgent(FRIDGE_VIEWER);
		}
	}
}
