...
public final class GeofenceUtils {
    ...
    public static final String ACTION_CONNECTION_ERROR =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_CONNECTION_ERROR";

    public static final String ACTION_CONNECTION_SUCCESS =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_CONNECTION_SUCCESS";

    public static final String ACTION_GEOFENCES_ADDED =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_GEOFENCES_ADDED";

    public static final String ACTION_GEOFENCES_REMOVED =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_GEOFENCES_DELETED";

    public static final String ACTION_GEOFENCE_ERROR =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_GEOFENCES_ERROR";

    public static final String ACTION_GEOFENCE_TRANSITION =
            "ch.bfh.fbi.mobicomp.geofence.ACTION_GEOFENCE_TRANSITION";

    public static final String ACTION_GEOFENCE_TRANSITION_ERROR =
                    "ch.bfh.fbi.mobicomp.geofence.ACTION_GEOFENCE_TRANSITION_ERROR";

    // The Intent category used by all Location Services sample apps
    public static final String CATEGORY_LOCATION_SERVICES =
                    "ch.bfh.fbi.mobicomp.geofence.CATEGORY_LOCATION_SERVICES";
    ...
    public static final String EXTRA_CONNECTION_ERROR_CODE =
            "ch.bfh.fbi.mobicomp.geofence.EXTRA_CONNECTION_ERROR_CODE";

    public static final String EXTRA_CONNECTION_ERROR_MESSAGE =
            "ch.bfh.fbi.mobicomp.geofence.EXTRA_CONNECTION_ERROR_MESSAGE";

    public static final String EXTRA_GEOFENCE_STATUS =
            "ch.bfh.fbi.mobicomp.geofence.EXTRA_GEOFENCE_STATUS";

    /*
     * Keys for flattened geofences stored in SharedPreferences
     */
    public static final String KEY_LATITUDE = "ch.bfh.fbi.mobicomp.geofence.KEY_LATITUDE";

    public static final String KEY_LONGITUDE = "ch.bfh.fbi.mobicomp.geofence.KEY_LONGITUDE";

    public static final String KEY_RADIUS = "ch.bfh.fbi.mobicomp.geofence.KEY_RADIUS";

    public static final String KEY_EXPIRATION_DURATION =
            "ch.bfh.fbi.mobicomp.geofence.KEY_EXPIRATION_DURATION";

    public static final String KEY_TRANSITION_TYPE =
            "ch.bfh.fbi.mobicomp.geofence.KEY_TRANSITION_TYPE";

    // The prefix for flattened geofence keys
    public static final String KEY_PREFIX =
            "ch.bfh.fbi.mobicomp.geofence.KEY";
